...
* `azuredevops_project` - Handling 404 error code.  [#616](https://github.com/microsoft/terraform-provider-azuredevops/issues/614)
...
* Upgrade Terraform Plugin SDK to `v2.11.0` - [#543](https://github.com/microsoft/terraform-provider-azuredevops/issues/587)
