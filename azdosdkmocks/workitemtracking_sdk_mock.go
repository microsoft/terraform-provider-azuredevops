...
import (
	...
	webapi "github.com/microsoft/azure-devops-go-api/azuredevops/v6/webapi"
	workitemtracking "github.com/microsoft/azure-devops-go-api/azuredevops/v6/workitemtracking"
)
...
func (m *MockWorkitemtrackingClient) UpdateField(arg0 context.Context, arg1 workitemtracking.UpdateFieldArgs) (*workitemtracking.WorkItemField, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateField", arg0, arg1)
	ret0, _ := ret[0].(*workitemtracking.WorkItemField)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockWorkitemtrackingClientMockRecorder) UpdateField(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateField", reflect.TypeOf((*MockWorkitemtrackingClient)(nil).UpdateField), arg0, arg1)
}
