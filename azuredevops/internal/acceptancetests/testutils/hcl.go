...
// HclWorkItemQueryPermissions creates HCL for testing to set permissions on Work Item Queries
func HclWorkItemQueryPermissions(projectName string, path string) string {
	projectResource := HclProjectResource(projectName)
