...
var requiredTemplateTestProjectID = &requiredTemplateCheckProjectID
...
func TestCheckRequiredTemplate_ExpandFlatten_Roundtrip(t *testing.T) {
	...
	flattenCheckRequiredTemplate(resourceData, &requiredTemplateCheckTest, requiredTemplateCheckProjectID)

	requiredTemplateCheckAfterRoundTrip, projectID, err := expandCheckRequiredTemplate(resourceData)
