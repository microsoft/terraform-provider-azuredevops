...
func ResourceServiceEndpointJFrogArtifactoryV2() *schema.Resource {
	r := genBaseServiceEndpointResource(flattenServiceEndpointJFrogArtifactoryV2, expandServiceEndpointJFrogArtifactoryV2)
...
func flattenServiceEndpointJFrogArtifactoryV2(d *schema.ResourceData, serviceEndpoint *serviceendpoint.ServiceEndpoint, projectID *uuid.UUID) {
