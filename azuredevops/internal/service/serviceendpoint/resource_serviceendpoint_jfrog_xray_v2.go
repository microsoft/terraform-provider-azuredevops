...
func ResourceServiceEndpointJFrogXRayV2() *schema.Resource {
	r := genBaseServiceEndpointResource(flattenServiceEndpointJFrogXRayV2, expandServiceEndpointJFrogXRayV2)
...
func flattenServiceEndpointJFrogXRayV2(d *schema.ResourceData, serviceEndpoint *serviceendpoint.ServiceEndpoint, projectID *uuid.UUID) {
