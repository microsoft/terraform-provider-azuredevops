	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedReturn: map[string]string{
				...
				"work_item_types.3092183233.parent_work_item_reference_name": *workItemType1.Inherits,
				...
				"work_item_types.558344571.parent_work_item_reference_name": *workItemType2.Inherits,
