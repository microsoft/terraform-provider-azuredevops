---
layout: "azuredevops"
page_title: "AzureDevops: Data Source: azuredevops_workitemtrackingprocess_process"
description: |-
  Gets information about an existing process.
---

# Data Source: azuredevops_workitemtrackingprocess_process
...
```hcl
data "azuredevops_workitemtrackingprocess_process" "example" {
  id = "adcc42ab-9882-485e-a3ed-7678f01f66bc"
}

output "id" {
  value = data.azuredevops_workitemtrackingprocess_process.example.id
}
```
