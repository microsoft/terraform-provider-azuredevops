...
* `create` - (Defaults to 2 minutes) Used when creating the JFrog Platform V2 Service Endpoint.
* `read` - (Defaults to 1 minute) Used when retrieving the JFrog Platform V2 Service Endpoint.
* `update` - (Defaults to 2 minutes) Used when updating the JFrog Platform V2 Service Endpoint.
* `delete` - (Defaults to 2 minutes) Used when deleting the JFrog Platform V2 Service Endpoint.
